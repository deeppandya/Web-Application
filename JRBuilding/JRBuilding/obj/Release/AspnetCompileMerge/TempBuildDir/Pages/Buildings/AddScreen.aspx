<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddScreen.aspx.cs" Inherits="JRBuilding.Pages.Buildings.AddScreen" %>
...
<body class="bg-black">
    ...
    <section class="content bg-black">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="grid" runat="server" Width="100%" Visible="false">
